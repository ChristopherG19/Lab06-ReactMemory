...
const cardsImg = [
  { "src": "/img/Ardilla.png", Coincidencia: false },
  { "src": "/img/Crecer.png", Coincidencia: false },
  { "src": "/img/Estrella.png", Coincidencia: false },
  { "src": "/img/Gato.png", Coincidencia: false },
  { "src": "/img/Hielo.png", Coincidencia: false },
  { "src": "/img/Hoja.png", Coincidencia: false },
  { "src": "/img/Moneda.png", Coincidencia: false },
  { "src": "/img/Vida.png", Coincidencia: false }
]
...
const App = () => {
  ...
  function CartaInd({ carta, Manejo, Volteada, deshabilitado }) {
    ...
    return (
      <div className="carta" key={carta.id} style={CartaStyle}>
        <div>
          <img 
            className="Cubierta" 
          ...
          <img 
            className="Fondo" src="/img/Question_Block.png" 
  ...
  return (
    <div style={Fondo}>
      <h1 style ={h1}>Incredible Memory</h1>
